...
void test_double_sha256_basic(void)
{
    ...
    double_sha256((const uint8_t*)test_input, strlen(test_input), hash);
...
void test_double_sha256_empty(void)
{
    ...
    double_sha256(empty_data, 0, hash);
...
void test_double_sha256_deterministic(void)
{
    ...
    double_sha256((const uint8_t*)test_input, strlen(test_input), hash1);
    double_sha256((const uint8_t*)test_input, strlen(test_input), hash2);
